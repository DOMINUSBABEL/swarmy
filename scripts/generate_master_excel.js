...
function generateMasterExcel() {
    ...
    const accountsData = [
        ...
        { account_id: 'acc_camila', username: 'moreno_cam73152', password: 'Habiaunavez205@', status: 'active', persona_type: 'general' },
        ...
        { account_id: 'acc_santiago', username: 'SPerdomito35341', password: 'Habiaunavez205@', status: 'active', persona_type: 'policy_analyst' }
    ];
